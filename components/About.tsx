  ...
  const about: About[] = [
    {
      title: "Education",
      description:
        "Final Year Computer Science UnderGraduate at Aligarh College of Engineering and Technology",
    },
    {
      title: "Hackathon",
      description:
        "Ranked in the top 100 globally in the Virtusa Engineering Equity Hackathon 2023, showcasing problem-solving skills and innovative thinking. ",
    },
    {
      title: "Achievements",
      description:
        "Achieved specialist status on Codeforces with a maximum rating of 1589 and attained 4-star coder status on CodeChef with a maximum rating of 1821. ",
    },
    {
  ...
  return (
    <div className="bg-[#03001e]">
      ...
      <div className="flex flex-col items-center justify-center mt-4 gap-1 pb-8">
        ...
        <a href="https://github.com/Shriyagautam12">
