  ...
  const services: Service[] = [
    {
      name: "Experience",
      description:
        "I am working as a Frontend Developer Intern at Physics Wallah. During my tenure, I specialized in web development, focusing on enhancing user experience and performance",
      icon: () => (
